...
using ApplicationException = DienstDuizend.BusinessCatalogueService.Infrastructure.Exceptions.ApplicationException;

namespace DienstDuizend.BusinessCatalogueService.Infrastructure.Exceptions.Handlers;
